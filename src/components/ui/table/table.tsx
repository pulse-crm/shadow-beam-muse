...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn(
      "border-b border-border hover:bg-muted/40 transition-colors data-[state=selected]:bg-muted",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-10 px-3 text-left align-middle text-xs font-medium text-muted-foreground first:pl-5 last:pr-5",
      className
    )}
    {...props}
  />
